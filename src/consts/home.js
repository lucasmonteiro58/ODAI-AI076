export const fotos = [
  {
    ...
    text:
      'OBSERVE QUE ANTIGAMENTE HAVIA ESCOLAS MAIORES E ESCOLAS MENORES. VEJA O TELHADO, AS PORTAS, AS JANELAS E OUTROS DETALHES DAS ESCOLAS NO PASSADO. QUE DIFERENÇAS VOCÊ NOTA ENTRE AS ESCOLAS DO PASSADO E AS ESCOLAS DO PRESENTE?'
  },
  {
    id: 1,
